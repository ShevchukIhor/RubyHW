...
#p "result 11 : #{ (0...array.size).map { |i| i.chr(Encoding::UTF_8) } }"
#p "result 11 : #{ (0...array.size).map { |i| array[i].chr(Encoding::UTF_8) } }"
p '_________________________________________________________________________________________'

p "змінити місцями мінімальний і максимальний елементи масиву;"
#p "result 12 : #{ array.rotate(array.max, array.min) }"
p '_________________________________________________________________________________________'
