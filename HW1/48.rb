...
p array
p 'Определить количество участков, на которых его элементы монотонно убывают.'
p (1..array.size-2).select{ |i| (array[i-1] >= array[i]) && (array[i] >= array[i+1]) && (array[i+1] >= array[i+2])}
